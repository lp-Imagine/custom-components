...
import LpSvgIcon from './components/lp-svg-icon/index.ts';
import * as utils from './utils/index.js';

const components = [LpButton, LpTable, LpTablePage, LpRemoteSelect, LpSearchForm, LpSvgIcon];
...
// 全局导出
export { utils, LpButton, LpTable, LpTablePage, LpRemoteSelect, LpSearchForm, LpSvgIcon }
// 默认导出
